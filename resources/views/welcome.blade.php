...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Ricardo Aray Portafolio</title>
        ...
        <!-- Scripts -->
        @vite(['resources/css/styles.css', 'resources/css/swiper-bundle.min.css', 'resources/js/swiper-bundle.min.js', 'resources/js/main.js'])
    </head>
    <body>
        <!--==================== HEADER ====================-->
            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list grid">
                        ...
                        <li class="nav__item">
                            <a href="#contactLink" class="nav__link">
        ...
        <main class="main">
                        ...
                        <div class="home__img">
                            <svg class="home__blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g mask="url(#mask0)">
                                    ...
                                    <image class="home__blob-img" x="12" y="18" xlink:href="{{ Vite::asset('resources/img/perfil.png') }}"/>
                                </g>
                            </svg>
                        </div>

                        <div class="home__data">
                            <h1 class="home__title">Hi, Iam Alexa</h1>
            ...
            <section class="about section" id="about">
                ...
                <div class="about__container container grid">
                    <img src="{{ Vite::asset('resources/img/about.jpg') }}" alt="" class="about__img">
                    ...
                    <div class="about__buttons">
                        <a href="{{ Vite::asset('resources/pdf/Alexa-Cv.pdf') }}" class="button button--flex" target="_blank" download="CV.pdf">
            ...
            <section class="qualification section">
                <h2 class="section__title">Quialification</h2>
                ...
                <div class="portfolio__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="portfolio__content grid swiper-slide">
                            <img src="{{ Vite::asset('resources/img/portfolio1.jpg') }}" alt="" class="portfolio__img">
                        ...
                        <!--==================== PORTFOLIO 2====================-->
                        <div class="portfolio__content grid swiper-slide">
                            <img src="{{ Vite::asset('resources/img/portfolio2.jpg') }}" alt="" class="portfolio__img">
                            <div class="portfolio__data">
                        ...
                        <!--==================== PORTFOLIO 3====================-->
                        <div class="portfolio__content grid swiper-slide">
                            <img src="{{ Vite::asset('resources/img/portfolio3.jpg') }}" alt="" class="portfolio__img">
                            <div class="portfolio__data">
            ...
            <section class="project section">
                <div class="project__bg">
                    <div class="project__container container grid">
                        ...
                        <img src="{{ Vite::asset('resources/img/project.png') }}" alt="" class="project__img">
                    </div>
                </div>
            </section>
                ...
                <div class="testimonial__container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="testimonial__content swiper-slide">
                            <div class="testimonial__data">
                                <div class="testimonial__header">
                                    <img src="{{ Vite::asset('resources/img/testimonial1.jpg') }}" alt="" class="testimonial__img">
                        ...
                        <div class="testimonial__content swiper-slide">
                            <div class="testimonial__data">
                                <div class="testimonial__header">
                                    <img src="{{ Vite::asset('resources/img/testimonial2.jpg') }}" alt="" class="testimonial__img">
                        ...
                        <div class="testimonial__content swiper-slide">
                            <div class="testimonial__data">
                                <div class="testimonial__header">
                                    <img src="{{ Vite::asset('resources/img/testimonial3.jpg') }}" alt="" class="testimonial__img">
            ...
            <!--==================== CONTACT ME ====================-->
            <section class="contact section" id="contactLink">
                    ...
                    <div>
                        ...
                        <div class="contact__information">
                            ...
                            <div>
                                ...
                                <span class="contact__subtitle">alexa@gmail.com</span>
                            </div>
                        </div>
                        ...
                        <div class="contact__information">
                            ...
                            <div>
                                ...
                                <span class="contact__subtitle">Peru - Lima</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer__bg">
                <div class="footer__container container grid">
                    ...
                    <ul class="footer__links">
                        ...
                        <li>
                            <a href="#contactLink" class="footer__link">Contactme</a>
                        </li>
                    </ul>
